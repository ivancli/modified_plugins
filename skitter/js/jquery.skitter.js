...
(function ($) {
    ...
    var defaults = {
        ...
        // Resize even when it's not in Fullscreen mode
        resizeevennotfullscreen: false,
        ...
        multimedia_detection: false,

        multi_is_on_shown: false,
    ...
    $sk.fn.extend({
        ...
        setup: function () {
            ...
            if (self.settings.height_skitter) {
                this.box_skitter.height(self.settings.height_skitter);
            }
            if (self.settings.width_skitter) {
                this.box_skitter.width(self.settings.width_skitter);
            }
            ...
            this.settings.media_links = new Array();

            // Add image, link, animation type and label
            var addMediaLink = function (link, src, animation_type, label, target, media_type) {
                self.settings.media_links.push([src, link, animation_type, label, target, media_type]);
                ...
                $.ajax({
                    ...
                    success: function (xml) {
                        ...
                        $(xml).find('skitter slide').each(function () {
                            ...
                            var mediatype = ($(this).find('mediatype').text()) ? $(this).find('mediatype').text() : 'image';
            ...
            if (this.settings.show_randomly)
                this.settings.media_links.sort(function (a, b) {
                    return Math.random() - 0.5;
                });

            this.settings.image_atual = this.settings.media_links[0][0];
            ...
            if (this.settings.media_links.length > 1) {
                this.box_skitter.find('.prev_button').click(function () {
                    if (self.settings.is_animating == false) {
                        ...
                        if (self.settings.image_i == -2) {
                            self.settings.image_i = self.settings.media_links.length - 2;
                        }
                        else if (self.settings.image_i == -1) {
                            self.settings.image_i = self.settings.media_links.length - 1;
                        }
                ...
                if (self.settings.preview && self.settings.dots) {
                    ...
                    for (var i = 0; i < this.settings.media_links.length; i++) {
                        var li = $('<li></li>');
                        var img = $('<img />');
                        img.attr('src', this.settings.media_links[i][0]);
                        li.append(img);
                        preview.find('ul').append(li);
                    }

                    var width_preview_ul = parseInt(this.settings.media_links.length * 100);
        ...
        setImageLink: function () {
            var name_image = this.settings.media_links[this.settings.image_i][0];
        ...
        increasingImage: function () {
            ...
            if (this.settings.image_i == this.settings.media_links.length) {
...
//            img_clone.width(600).height(400);
        ...
        stopOnMouseOver: function () {
            ...
            if (self.settings.stop_over) {
                self.box_skitter.hover(function () {
                    ...
                    if (!self.settings.is_animating && self.settings.media_links.length > 1) {
                        self.timer = setTimeout(function () {
                            self.completeMove();
        ...
        windowFocusOut: function () {
            ...
            $(window).bind('focus', function () {
                if (self.settings.media_links.length > 1) {
