...
!function (e) {
    ...
    e.fn.tooltip.defaults = {animation: true, placement: "top", selector: false, template: '<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover focus", title: "", delay: 0, html: false, container: false};
...
!function (e) {
    ...
    var t = function (t, n) {
        ...
        this.updateSource = this.options.updateSource || this.updateSource;
...
//        }
    ...
    e.fn.typeahead.defaults = {source: [], items: 8, menu: '<ul class="typeahead dropdown-menu"></ul>', item: '<li><a href="#"></a></li>', minLength: 0};
